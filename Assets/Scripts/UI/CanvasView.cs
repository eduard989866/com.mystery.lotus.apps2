...
namespace FTyuikqlwe
{
    public class CanvasView : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("profileScreen")] [SerializeField] private NBUioqwheIP ewfs;
...
.ToString();            _cntd = cntd;
            ...
            bgte.POHgwvyejqwpe(lvfeqxWwsq, usewcFwqeVver);
            mnsdf.IOjpqwejp(lvfeqxWwsq, usewcFwqeVver);
            bfsq.Bootstrap(lvfeqxWwsq);
            wevd.qweerfvrtrh34();
            ewfs.Uhoqiwejio(usewcFwqeVver);
